...
create table USERINFO(
    UserId character(32) primary key,
...
create table class (
    classid character(32) primary key,
    generatorid character varying(32) constraint userid references userinfo,
...
create table user_class_rel(
    ...
    userid character(32) constraint userid references userinfo,
    classid character(32) constraint classid references class,
